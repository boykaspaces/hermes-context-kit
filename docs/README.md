...
| File | Status | Description | Read when |
|---|---|---|---|
| [`ADOPTION.md`](./ADOPTION.md) | Current | Profiles, clean-room bootstrap, existing-project adoption, and optional runtime installation | Adopting the kit |
| [`ARCHITECTURE.md`](./ARCHITECTURE.md) | Current | Ownership layers and retrieval flow | Understanding why the structure is index-first |
